                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    <td valign="top" height="232" width="248">
                                                        ...
                                                        $pricetype = $_SESSION['data']['pricetype'];
                                                        $days = $_POST['days'];
                                                        if ($days!=0){
                                                            $price = $pricetype;
                                                        echo '<br>Тип путевки:  ';
                                                        ...
                                                        echo($country);
                                                        $priceofcountry2 = $_SESSION['data']['priceofcountry'];
                                                        echo(' - ');
                                                        ...
                                                        $dop1=$_POST['check1'];
                                                        $dop2=$_POST['check2'];
                                                        $priceofdop2 = $_SESSION['data']['priceofdop'];
                                                    ...
                                                    <td valign="top" height="215" width="243">
                                                        ...
                                                        echo '<br>Общая стоимость:';
                                                            ...
                                                            $date, $time, $_SESSION['data']['name'], $_SESSION['data']['email'], $_SESSION['data']['type'], $country, $price);
                                                            ?> 

                                                            

<br>
                                                            <?mail($email, 'Путевка', $_POST['q2']);?>
